...
import { LessonJourneyController } from '../features/modules/components/journey/LessonJourneyController';
        ...
        <div className="mb-8">
          ...
          <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
            <div
              ...
              style={{ width: `${modules[moduleId]?.percent ?? 0}%` }}
            />
          </div>
        </div>

        <LessonJourneyController
          moduleId={moduleId}
          lessons={parsedModule.lessons}
