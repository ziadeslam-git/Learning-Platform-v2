      ...
      <header className="fixed top-0 left-0 w-full z-50 p-6 glass border-b-0 border-white/5">
        <div className="max-w-7xl mx-auto flex items-center justify-between flex-row-reverse">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/stats"
              className="flex items-center gap-2 px-5 py-2.5 bg-white/5 hover:bg-white/10 text-gray-200 border border-white/10 rounded-xl transition-all hover:-translate-y-0.5"
            >
